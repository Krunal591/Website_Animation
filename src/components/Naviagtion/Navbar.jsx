    ...
    return (
        <div className='flex fixed top-0 z-4  w-full items-start justify-between'>
            ...
            <div onClick={()=>{
                ...
                className='relative lg:h-14 h-10 lg:w-[16vw] w-44 bg-black'>
                <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'></div>
                <div className='relative h-full lg:px-12 px-8 flex flex-col justify-center items-end lg:gap-1 gap-0.5'>
